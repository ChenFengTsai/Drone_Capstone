...
def main():
    ...
    while not found_bottle:
        ...
        frame, found_bottle = process_frame(frame, model, device, imgsz)
    ...
    while found_bottle:
        ...
        frame, _ = process_frame(frame, model, device, imgsz)
        cv2.imshow('DJI Tello Live Object Detection', frame)
